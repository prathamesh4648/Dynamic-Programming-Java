...
public class DP39_stock_cooldown {
    ...
    public static int stocks3(int n,int p[],int buy,int cap,int length,int dp[][][]){
        ...
        if(buy==1){
            ...
            return dp[n][buy][cap] = Math.max(p[n]+stocks3(n+2,p,1,cap-1,length),0 + stocks3(n+1,p,0,cap,length));
        }
    ...
    public static void main(String args[]){
        ...
        System.out.println(stocks3(0,p,1,2,8));
        System.out.println(stock_y(p));
